...
function $s_Lscalajs_fun_Main__main__AT__V(args) {
  $m_Lscalajs_fun_Main$().main__AT__V(args);
}
/** @constructor */
function $c_Lscalajs_fun_Main$() {
}
$c_Lscalajs_fun_Main$.prototype = new $h_O();
$c_Lscalajs_fun_Main$.prototype.constructor = $c_Lscalajs_fun_Main$;
/** @constructor */
function $h_Lscalajs_fun_Main$() {
}
$h_Lscalajs_fun_Main$.prototype = $c_Lscalajs_fun_Main$.prototype;
$c_Lscalajs_fun_Main$.prototype.main__AT__V = (function(args) {
  var rw = new $c_Lscalajs_fun_randomWalks_RandomWalk(15);
  var this$1 = $n(rw.Lscalajs_fun_randomWalks_RandomWalk__f_periodic);
  $f_Lscalajs_fun_util_Periodic__start__V(this$1);
});
var $d_Lscalajs_fun_Main$ = new $TypeData().initClass($c_Lscalajs_fun_Main$, "scalajs.fun.Main$", ({
  Lscalajs_fun_Main$: 1
}));
var $n_Lscalajs_fun_Main$;
function $m_Lscalajs_fun_Main$() {
  if ((!$n_Lscalajs_fun_Main$)) {
    $n_Lscalajs_fun_Main$ = new $c_Lscalajs_fun_Main$();
  }
  return $n_Lscalajs_fun_Main$;
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__inBorder__I__Z($thiz, n) {
  return ((n === 0) || (n === (((-1) + $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_dimension) | 0)));
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__escapes__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, p) {
  return ($p_Lscalajs_fun_randomWalks_RandomWalk__inBorder__I__Z($thiz, $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x) || $p_Lscalajs_fun_randomWalks_RandomWalk__inBorder__I__Z($thiz, $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y));
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__neighbours__Lscalajs_fun_randomWalks_RandomWalk$Pos__ALscalajs_fun_randomWalks_RandomWalk$Pos($thiz, p) {
  return new ($d_Lscalajs_fun_randomWalks_RandomWalk$Pos.getArrayOf().constr)([$n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1).apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos((((-1) + $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x) | 0), $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y), $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1).apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos(((1 + $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x) | 0), $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y), $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1).apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos($n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x, (((-1) + $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y) | 0)), $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1).apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos($n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x, ((1 + $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y) | 0))]);
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__blocked__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, p) {
  var xs = $p_Lscalajs_fun_randomWalks_RandomWalk__neighbours__Lscalajs_fun_randomWalks_RandomWalk$Pos__ALscalajs_fun_randomWalks_RandomWalk$Pos($thiz, p);
  var i = 0;
  while ((i < $n(xs).u.length)) {
    var x1 = i;
    var arg1 = $n(xs).get(x1);
    var p$1 = $as_Lscalajs_fun_randomWalks_RandomWalk$Pos(arg1);
    if ((!$n($n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_visited).get($n(p$1).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x)).get($n(p$1).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y))) {
      return false;
    }
    i = ((1 + i) | 0);
  }
...
function $p_Lscalajs_fun_randomWalks_RandomWalk__unvisited__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, p) {
  return (!$n($n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_visited).get($n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x)).get($n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y));
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__oneStep__s_util_Random__Lscalajs_fun_randomWalks_RandomWalk$Pos__Lscalajs_fun_randomWalks_RandomWalk$Pos($thiz, rnd, p) {
  var positions = $p_Lscalajs_fun_randomWalks_RandomWalk__neighbours__Lscalajs_fun_randomWalks_RandomWalk$Pos__ALscalajs_fun_randomWalks_RandomWalk$Pos($thiz, p);
  var this$1 = $n(rnd);
  var n = $n(positions).u.length;
  var i = $n(this$1.s_util_Random__f_self).nextInt__I__I(n);
  while ((!$p_Lscalajs_fun_randomWalks_RandomWalk__unvisited__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, $n(positions).get(i)))) {
    i = $intMod(((1 + i) | 0), $n(positions).u.length);
  }
  return $n(positions).get(i);
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__D__D__T2($thiz, x, y) {
  var _1 = (x * $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize);
  var _2 = (y * $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize);
  return new $c_T2(_1, _2);
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__Lscalajs_fun_randomWalks_RandomWalk$Pos__T2($thiz, p) {
  var x = $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x;
  var x$1 = $n(p).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y;
  return $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__D__D__T2($thiz, x, x$1);
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__circle__Lscalajs_fun_randomWalks_RandomWalk$Pos__D__T__T__V($thiz, pos, radius, outline, fill) {
  matchResult4: {
    var \u03b42$___1;
    var \u03b42$___2;
    var x5 = $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__Lscalajs_fun_randomWalks_RandomWalk$Pos__T2($thiz, pos);
    if ((x5 !== null)) {
      var x = $uD($n(x5).T2__f__1);
      var y = $uD($n(x5).T2__f__2);
      var \u03b42$___1 = x;
      var \u03b42$___2 = y;
      break matchResult4;
    }
  ...
  var x$2 = $uD(\u03b42$___1);
  var y$2 = $uD(\u03b42$___2);
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.beginPath();
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.arc((x$2 + ($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize / 2.0)), (y$2 + ($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize / 2.0)), radius, 0.0, 6.283185307179586);
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.fillStyle = fill;
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.fill();
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.strokeStyle = outline;
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.stroke();
}
function $p_Lscalajs_fun_randomWalks_RandomWalk___line__D__D__D__D__V($thiz, x0, y0, x1, y1) {
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.beginPath();
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.moveTo(x0, y0);
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.lineTo(x1, y1);
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.stroke();
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__line__D__D__D__D__V($thiz, x0, y0, x1, y1) {
  matchResult5: {
    var \u03b43$___1;
    var \u03b43$___2;
    var x8 = $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__D__D__T2($thiz, x0, y0);
    if ((x8 !== null)) {
      var p0x = $uD($n(x8).T2__f__1);
      var p0y = $uD($n(x8).T2__f__2);
      var \u03b43$___1 = p0x;
      var \u03b43$___2 = p0y;
      break matchResult5;
    }
  ...
  var p0x$2 = $uD(\u03b43$___1);
  var p0y$2 = $uD(\u03b43$___2);
  matchResult6: {
    var \u03b44$___1;
    var \u03b44$___2;
    var x11 = $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__D__D__T2($thiz, x1, y1);
    if ((x11 !== null)) {
      var p1x = $uD($n(x11).T2__f__1);
      var p1y = $uD($n(x11).T2__f__2);
      var \u03b44$___1 = p1x;
      var \u03b44$___2 = p1y;
      break matchResult6;
    }
  ...
  var p1x$2 = $uD(\u03b44$___1);
  var p1y$2 = $uD(\u03b44$___2);
  $p_Lscalajs_fun_randomWalks_RandomWalk___line__D__D__D__D__V($thiz, p0x$2, p0y$2, p1x$2, p1y$2);
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__line__Lscalajs_fun_randomWalks_RandomWalk$Pos__Lscalajs_fun_randomWalks_RandomWalk$Pos__V($thiz, p0, p1) {
  matchResult7: {
    var \u03b45$___1;
    var \u03b45$___2;
    var x14 = $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__Lscalajs_fun_randomWalks_RandomWalk$Pos__T2($thiz, p0);
    if ((x14 !== null)) {
      var p0x = $uD($n(x14).T2__f__1);
      var p0y = $uD($n(x14).T2__f__2);
      var \u03b45$___1 = p0x;
      var \u03b45$___2 = p0y;
      break matchResult7;
    }
  ...
  var p0x$2 = $uD(\u03b45$___1);
  var p0y$2 = $uD(\u03b45$___2);
  matchResult8: {
    var \u03b46$___1;
    var \u03b46$___2;
    var x17 = $p_Lscalajs_fun_randomWalks_RandomWalk__coordinates__Lscalajs_fun_randomWalks_RandomWalk$Pos__T2($thiz, p1);
    if ((x17 !== null)) {
      var p1x = $uD($n(x17).T2__f__1);
      var p1y = $uD($n(x17).T2__f__2);
      var \u03b46$___1 = p1x;
      var \u03b46$___2 = p1y;
      break matchResult8;
    }
  ...
  var p1x$2 = $uD(\u03b46$___1);
  var p1y$2 = $uD(\u03b46$___2);
  var offset = ($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize / 2.0);
  $p_Lscalajs_fun_randomWalks_RandomWalk___line__D__D__D__D__V($thiz, (p0x$2 + offset), (p0y$2 + offset), (p1x$2 + offset), (p1y$2 + offset));
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__drawPos__I__V($thiz, i) {
  var this$1 = $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution);
  var this$2 = $n(this$1.scm_ListBuffer__f_first);
  var p = $as_Lscalajs_fun_randomWalks_RandomWalk$Pos($f_sc_LinearSeqOps__apply__I__O(this$2, i));
  var smallRadius = ($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize / 6.0);
  var largeRadius = ($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize / 3.0);
  $thiz.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.lineWidth = 2.0;
  if ((i === 0)) {
    $p_Lscalajs_fun_randomWalks_RandomWalk__circle__Lscalajs_fun_randomWalks_RandomWalk$Pos__D__T__T__V($thiz, p, largeRadius, "black", "gray");
  } else if ((i === (((-1) + $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution).scm_ListBuffer__f_len) | 0))) {
    if (($p_Lscalajs_fun_randomWalks_RandomWalk__escapes__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, p) || (!$p_Lscalajs_fun_randomWalks_RandomWalk__blocked__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z($thiz, p)))) {
      var \u03b47$___1 = "darkgreen";
      var \u03b47$___2 = "limegreen";
    } else {
      var \u03b47$___1 = "#aa0000";
      var \u03b47$___2 = "red";
    }
    var outline = $as_T(\u03b47$___1);
    var fill = $as_T(\u03b47$___2);
    $p_Lscalajs_fun_randomWalks_RandomWalk__circle__Lscalajs_fun_randomWalks_RandomWalk$Pos__D__T__T__V($thiz, p, largeRadius, outline, fill);
  } else {
    $p_Lscalajs_fun_randomWalks_RandomWalk__circle__Lscalajs_fun_randomWalks_RandomWalk$Pos__D__T__T__V($thiz, p, smallRadius, "blue", "cornflowerblue");
  }
}
function $p_Lscalajs_fun_randomWalks_RandomWalk__setupGUI__Lorg_scalajs_dom_HTMLElement($thiz) {
  var button = document.createElement("button");
  button.innerText = "Go!";
  button.title = "Click for a new random walk";
  button.onclick = ((ev) => {
    var this$2 = $n($thiz.Lscalajs_fun_randomWalks_RandomWalk__f_periodic);
    $f_Lscalajs_fun_util_Periodic__start__V(this$2);
  });
...
/** @constructor */
function $c_Lscalajs_fun_randomWalks_RandomWalk(n) {
  this.Lscalajs_fun_randomWalks_RandomWalk__f_n = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1 = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_visited = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize = 0.0;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_periodic = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$output = null;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_n = n;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1 = new $c_Lscalajs_fun_randomWalks_RandomWalk$Pos$(this);
  this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension = ((1 + (n << 1)) | 0);
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalajs_fun_randomWalks_RandomWalk$Pos.getArrayOf().constr)([]));
  this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution = new $c_scm_ListBuffer().scala$collection$mutable$ListBuffer$$freshFrom__sc_IterableOnce__scm_ListBuffer(elems);
  var dimensions = new $ac_I(new Int32Array([this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension, this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension]));
  this.Lscalajs_fun_randomWalks_RandomWalk__f_visited = $asArrayOf_Z($m_jl_reflect_Array$().newInstance__jl_Class__AI__O($d_Z.getClassOf(), dimensions), 2);
  var canvas = document.getElementById("canvas");
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D = canvas.getContext("2d");
  var _1 = $doubleToInt((0.8 * $uD(window.innerWidth)));
  var _2 = $doubleToInt((0.8 * $uD(window.innerHeight)));
  canvas.width = _1;
  canvas.height = _2;
  var pixels = ((_1 < _2) ? _1 : _2);
  var cellSz = (pixels / this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension);
  var scale = (pixels / (this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension * cellSz));
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.setTransform(scale, 0.0, 0.0, scale, 0.0, 0.0);
  this.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize = cellSz;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_periodic = new $c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1(this);
  this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$output = $p_Lscalajs_fun_randomWalks_RandomWalk__setupGUI__Lorg_scalajs_dom_HTMLElement(this);
}
$c_Lscalajs_fun_randomWalks_RandomWalk.prototype = new $h_O();
$c_Lscalajs_fun_randomWalks_RandomWalk.prototype.constructor = $c_Lscalajs_fun_randomWalks_RandomWalk;
/** @constructor */
function $h_Lscalajs_fun_randomWalks_RandomWalk() {
}
$h_Lscalajs_fun_randomWalks_RandomWalk.prototype = $c_Lscalajs_fun_randomWalks_RandomWalk.prototype;
$c_Lscalajs_fun_randomWalks_RandomWalk.prototype.scalajs$fun$randomWalks$RandomWalk$$randomSolution__I__V = (function(seed) {
  var rnd = $ct_s_util_Random__I__(new $c_s_util_Random(), seed);
  var end = this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension;
  var isEmpty = (end <= 0);
  ...
  if ((!isEmpty)) {
    ...
    while (true) {
      var arg1 = i;
      var end$1 = this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension;
      ...
      if ((!isEmpty$1)) {
        ...
        while (true) {
          var arg1$1 = i$1;
          $n($n(this.Lscalajs_fun_randomWalks_RandomWalk__f_visited).get(arg1)).set(arg1$1, false);
  ...
  var pos = $n(this.Lscalajs_fun_randomWalks_RandomWalk__f_Pos$lzy1).apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos(this.Lscalajs_fun_randomWalks_RandomWalk__f_n, this.Lscalajs_fun_randomWalks_RandomWalk__f_n);
  $n($n(this.Lscalajs_fun_randomWalks_RandomWalk__f_visited).get(this.Lscalajs_fun_randomWalks_RandomWalk__f_n)).set(this.Lscalajs_fun_randomWalks_RandomWalk__f_n, true);
  var elems = $m_sr_ScalaRunTime$().wrapRefArray__AO__sci_ArraySeq(new ($d_Lscalajs_fun_randomWalks_RandomWalk$Pos.getArrayOf().constr)([pos]));
  this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution = new $c_scm_ListBuffer().scala$collection$mutable$ListBuffer$$freshFrom__sc_IterableOnce__scm_ListBuffer(elems);
  while (((!$p_Lscalajs_fun_randomWalks_RandomWalk__escapes__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z(this, pos)) && (!$p_Lscalajs_fun_randomWalks_RandomWalk__blocked__Lscalajs_fun_randomWalks_RandomWalk$Pos__Z(this, pos)))) {
    pos = $p_Lscalajs_fun_randomWalks_RandomWalk__oneStep__s_util_Random__Lscalajs_fun_randomWalks_RandomWalk$Pos__Lscalajs_fun_randomWalks_RandomWalk$Pos(this, rnd, pos);
    $n($n(this.Lscalajs_fun_randomWalks_RandomWalk__f_visited).get($n(pos).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x)).set($n(pos).Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y, true);
    var this$12 = $n(this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution);
    var elem = pos;
    this$12.addOne__O__scm_ListBuffer(elem);
  }
});
$c_Lscalajs_fun_randomWalks_RandomWalk.prototype.scalajs$fun$randomWalks$RandomWalk$$drawBoard__V = (function() {
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.clearRect(0.0, 0.0, (this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension * this.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize), (this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension * this.Lscalajs_fun_randomWalks_RandomWalk__f_cellSize));
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.lineWidth = 0.5;
  this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.strokeStyle = "gray";
  var end = this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension;
  var isEmpty = (end < 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      var arg1 = i;
      var x = this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension;
      $p_Lscalajs_fun_randomWalks_RandomWalk__line__D__D__D__D__V(this, arg1, 0.0, arg1, x);
      if ((i === end)) {
        break;
      }
      i = ((1 + i) | 0);
  ...
  if ((!isEmpty$1)) {
    ...
    while (true) {
      var arg1$1 = i$1;
      var x$1 = this.Lscalajs_fun_randomWalks_RandomWalk__f_dimension;
      $p_Lscalajs_fun_randomWalks_RandomWalk__line__D__D__D__D__V(this, 0.0, arg1$1, x$1, arg1$1);
      if ((i$1 === end$1)) {
        break;
      }
      i$1 = ((1 + i$1) | 0);
...
$c_Lscalajs_fun_randomWalks_RandomWalk.prototype.scalajs$fun$randomWalks$RandomWalk$$drawFrame__I__V = (function(i) {
  if ((i > 0)) {
    this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.lineWidth = 2.0;
    this.Lscalajs_fun_randomWalks_RandomWalk__f_g2D.strokeStyle = "blue";
    var this$2 = $n(this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution);
    var i$1 = (((-1) + i) | 0);
    var this$3 = $n(this$2.scm_ListBuffer__f_first);
    var $x_1 = $as_Lscalajs_fun_randomWalks_RandomWalk$Pos($f_sc_LinearSeqOps__apply__I__O(this$3, i$1));
    var this$4 = $n(this.Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution);
    var this$5 = $n(this$4.scm_ListBuffer__f_first);
    $p_Lscalajs_fun_randomWalks_RandomWalk__line__Lscalajs_fun_randomWalks_RandomWalk$Pos__Lscalajs_fun_randomWalks_RandomWalk$Pos__V(this, $x_1, $as_Lscalajs_fun_randomWalks_RandomWalk$Pos($f_sc_LinearSeqOps__apply__I__O(this$5, i)));
    $p_Lscalajs_fun_randomWalks_RandomWalk__drawPos__I__V(this, (((-1) + i) | 0));
    $p_Lscalajs_fun_randomWalks_RandomWalk__drawPos__I__V(this, i);
  }
});
var $d_Lscalajs_fun_randomWalks_RandomWalk = new $TypeData().initClass($c_Lscalajs_fun_randomWalks_RandomWalk, "scalajs.fun.randomWalks.RandomWalk", ({
  Lscalajs_fun_randomWalks_RandomWalk: 1
}));
function $p_Lscalajs_fun_util_Periodic__go__V($thiz) {
  $thiz.onStart__V();
  var timeout = (1000.0 / $thiz.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_Hz);
  var handle = $uI(window.setInterval((() => ($thiz.finished__Z() ? ($f_Lscalajs_fun_util_Periodic__stop__V($thiz), (void 0)) : ($thiz.onTick__V(), (void 0)))), timeout));
  $thiz.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt = new $c_s_Some(handle);
}
function $f_Lscalajs_fun_util_Periodic__start__V($thiz) {
  var x1 = $thiz.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt;
  var x = $m_s_None$();
  if ((x === x1)) {
    $p_Lscalajs_fun_util_Periodic__go__V($thiz);
    return (void 0);
  }
  if ((x1 instanceof $c_s_Some)) {
    $uI($n($as_s_Some(x1)).s_Some__f_value);
    $f_Lscalajs_fun_util_Periodic__stop__V($thiz);
    $p_Lscalajs_fun_util_Periodic__go__V($thiz);
    return (void 0);
  }
  throw new $c_s_MatchError(x1);
}
function $f_Lscalajs_fun_util_Periodic__stop__V($thiz) {
  var x4 = $thiz.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt;
  var x = $m_s_None$();
  if ((x === x4)) {
    return (void 0);
  }
  if ((x4 instanceof $c_s_Some)) {
    var handle = $uI($n($as_s_Some(x4)).s_Some__f_value);
    window.clearInterval(handle);
    $thiz.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt = $m_s_None$();
    return (void 0);
  }
...
/** @constructor */
function $c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1(outer) {
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt = null;
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_Hz = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer = null;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException();
  }
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer = outer;
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_scalajs$fun$util$Periodic$$handleOpt = $m_s_None$();
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_Hz = 60;
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame = 0;
}
$c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype = new $h_O();
$c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype.constructor = $c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1;
/** @constructor */
function $h_Lscalajs_fun_randomWalks_RandomWalk$$anon$1() {
}
$h_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype = $c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype;
$c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype.finished__Z = (function() {
  return (this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame >= $n($n(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer).Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$solution).scm_ListBuffer__f_len);
});
$c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype.onStart__V = (function() {
  var this$1 = $m_s_util_Random$();
  var seed = $n(this$1.s_util_Random__f_self).nextInt__I__I(2147483647);
  $n(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer).Lscalajs_fun_randomWalks_RandomWalk__f_scalajs$fun$randomWalks$RandomWalk$$output.innerText = ((" Using " + seed) + " as random seed");
  $n(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer).scalajs$fun$randomWalks$RandomWalk$$randomSolution__I__V(seed);
  $n(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer).scalajs$fun$randomWalks$RandomWalk$$drawBoard__V();
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame = 0;
});
$c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1.prototype.onTick__V = (function() {
  $n(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_$outer).scalajs$fun$randomWalks$RandomWalk$$drawFrame__I__V(this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame);
  this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame = ((1 + this.Lscalajs_fun_randomWalks_RandomWalk$$anon$1__f_frame) | 0);
});
var $d_Lscalajs_fun_randomWalks_RandomWalk$$anon$1 = new $TypeData().initClass($c_Lscalajs_fun_randomWalks_RandomWalk$$anon$1, "scalajs.fun.randomWalks.RandomWalk$$anon$1", ({
  Lscalajs_fun_randomWalks_RandomWalk$$anon$1: 1,
  Lscalajs_fun_util_Periodic: 1
}));
/** @constructor */
...
/** @constructor */
function $c_Lscalajs_fun_randomWalks_RandomWalk$Pos$(outer) {
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos$__f_$outer = null;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException();
  }
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos$__f_$outer = outer;
}
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype = new $h_O();
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype.constructor = $c_Lscalajs_fun_randomWalks_RandomWalk$Pos$;
/** @constructor */
function $h_Lscalajs_fun_randomWalks_RandomWalk$Pos$() {
}
$h_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype = $c_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype;
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype.apply__I__I__Lscalajs_fun_randomWalks_RandomWalk$Pos = (function(x, y) {
  return new $c_Lscalajs_fun_randomWalks_RandomWalk$Pos(this.Lscalajs_fun_randomWalks_RandomWalk$Pos$__f_$outer, x, y);
});
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos$.prototype.toString__T = (function() {
  return "Pos";
});
var $d_Lscalajs_fun_randomWalks_RandomWalk$Pos$ = new $TypeData().initClass($c_Lscalajs_fun_randomWalks_RandomWalk$Pos$, "scalajs.fun.randomWalks.RandomWalk$Pos$", ({
  Lscalajs_fun_randomWalks_RandomWalk$Pos$: 1,
  s_deriving_Mirror: 1,
...
/** @constructor */
function $c_Lscalajs_fun_randomWalks_RandomWalk$Pos(outer, x, y) {
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y = 0;
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_$outer = null;
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x = x;
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y = y;
  if ((outer === null)) {
    throw new $c_jl_NullPointerException();
  }
  this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_$outer = outer;
}
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype = new $h_O();
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.constructor = $c_Lscalajs_fun_randomWalks_RandomWalk$Pos;
/** @constructor */
...
$h_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype = $c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype;
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.productIterator__sc_Iterator = (function() {
  return new $c_s_Product$$anon$1(this);
});
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.hashCode__I = (function() {
  var acc = (-889275714);
  var hash = acc;
  var data = $f_T__hashCode__I("Pos");
  acc = $m_sr_Statics$().mix__I__I__I(hash, data);
  var hash$1 = acc;
  var data$1 = this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x;
  acc = $m_sr_Statics$().mix__I__I__I(hash$1, data$1);
  var hash$2 = acc;
  var data$2 = this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y;
...
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.productArity__I = (function() {
  return 2;
});
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.productPrefix__T = (function() {
  return "Pos";
});
$c_Lscalajs_fun_randomWalks_RandomWalk$Pos.prototype.productElement__I__O = (function(n) {
  if ((n === 0)) {
    return this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_x;
  }
  if ((n === 1)) {
    return this.Lscalajs_fun_randomWalks_RandomWalk$Pos__f_y;
  }
  throw $ct_jl_IndexOutOfBoundsException__T__(new $c_jl_IndexOutOfBoundsException(), ("" + n));
});
function $as_Lscalajs_fun_randomWalks_RandomWalk$Pos(obj) {
  return (((obj instanceof $c_Lscalajs_fun_randomWalks_RandomWalk$Pos) || (obj === null)) ? obj : $throwClassCastException(obj, "scalajs.fun.randomWalks.RandomWalk$Pos"));
}
function $isArrayOf_Lscalajs_fun_randomWalks_RandomWalk$Pos(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lscalajs_fun_randomWalks_RandomWalk$Pos)));
}
function $asArrayOf_Lscalajs_fun_randomWalks_RandomWalk$Pos(obj, depth) {
  return (($isArrayOf_Lscalajs_fun_randomWalks_RandomWalk$Pos(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscalajs.fun.randomWalks.RandomWalk$Pos;", depth));
}
var $d_Lscalajs_fun_randomWalks_RandomWalk$Pos = new $TypeData().initClass($c_Lscalajs_fun_randomWalks_RandomWalk$Pos, "scalajs.fun.randomWalks.RandomWalk$Pos", ({
  Lscalajs_fun_randomWalks_RandomWalk$Pos: 1,
  s_Equals: 1,
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lscalajs_fun_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
